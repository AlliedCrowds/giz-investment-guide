export default {
  path: 'active-investors',
  title: 'Other Types of Investors Active in Nigeria',
  description:
    'The following are various types of investors you can find out about.',
  linkedList: [
    {
      linkText: 'Accelerators / Incubators',
      text:
        'Work with early-stage start-ups to help them refine their idea/product, and coach them on how to realize their vision',
      path: 'accelerator',
    },
    {
      linkText: 'Angel Investor Networks',
      text:
